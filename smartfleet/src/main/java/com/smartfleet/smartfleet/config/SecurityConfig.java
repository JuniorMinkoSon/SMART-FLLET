...
public class SecurityConfig {
    ...
    /**
     * Regles d'acces. Volontairement minimalistes ici : l'autorisation fine est
     * portee par les @PreAuthorize des controleurs, qui sont la source unique de
     * verite. Auparavant les deux se contredisaient (ex. GET /api/vehicles etait
     * interdit au CONDUCTEUR ici mais autorise sur le controleur), ce qui
     * produisait des 401 sur des routes pourtant legitimes.
     */
    @Bean
